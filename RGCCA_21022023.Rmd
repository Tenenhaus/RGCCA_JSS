...
$c = c_L\circ c_{L-1}\circ ... \circ c_1$, where $\circ$ stands for the 
...
```{r, fig.align='center', fig.cap = 'correlation circle associated with the two first components of Ariculture', fig.height = 12, fig.width=18}
...
```{r, fig.align='center', fig.cap = 'biplot associated with the two first components of Ariculture', fig.height = 12, fig.width=18}
...
```{r, fig.align='center', fig.cap = 'A biplot graphical display of the countries obtained by crossing the two first components of the superblock. Individuals are labeled according to their political regime and variables according to their block membership.', fig.height = 12, fig.width=18}
