...
When performing a Principal Component Analysis (PCA) (@Pearson1901), a way to 
...
to the procedure proposed in [@Zou2006].

[@Tenenhaus1998] defines the Variable Importance in Projection
...
```{r, fig.align='center', fig.cap = '\\label{fig:sample}graphical display of the countries obtained by crossing y11 and y21 and labeled according to their political regime', fig.height = 12, fig.width=18}
...
```{r, fig.align='center', fig.cap = 'correlation circle associated with the two first components of Agriculture', fig.height = 12, fig.width=18, fig.pos = "H"}
...
```{r, fig.align='center', fig.cap = 'biplot associated with the two first components of Agriculture', fig.height = 12, fig.width=18, fig.pos = "H"}
