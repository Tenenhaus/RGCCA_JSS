...
Equations (\ref{AVE_X}) is defined for a specific block component. The cumulative 
AVE el quality When several components are obtained, the cumulative AVE is 
...
We use here the `n_mark` parameter to display the 50 variables with the higher
absolute values.
