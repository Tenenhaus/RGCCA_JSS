...
statistical framework that subsumes as special cases an astonishinggly large 
number of multiblock component methods. 
In this paper, we present an R package called RGCCA (Girka et al, 2023)
that implements the RGCCA framework. Its usefulness and versatility are 
illustrated in this paper. The package includes several utility functions for 
data preprocessing and visualization. In addition, the package includes several 
